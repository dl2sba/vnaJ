...
public class VNADriverSerialVNArduinoDialog extends VNADriverDialog {
	...
	public VNADriverSerialVNArduinoDialog(VNAMainFrame pMainFrame, IVNADriver pDriver) {
		...
		driver = pDriver;
		dib = (VNADriverSerialVNArduinoDIB) driver.getDeviceInfoBlock();

		setTitle(VNADriverSerialVNArduinoMessages.getString("Dialog.title"));
		setDefaultCloseOperation(JDialog.DO_NOTHING_ON_CLOSE);
		setProperties(config);
		setConfigurationPrefix("VNADriverSerialVNArduinoDialog");
		...
		//
		lblMax = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblPhaseMax.text"));
		panel.add(lblMax, "");
		...
		lblPhaseMin = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblPhaseMin.text"));
		...
		lblNoOfSteps = new JLabel(VNADriverSerialVNArduinoMessages.getString("Dialog.lblNoOfSteps.text"));
		...
		lblOpenTimeout = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblOpenTimeout.text")); //$NON-NLS-1$
		...
		lblReadTimeout = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblReadTimeout.text")); //$NON-NLS-1$
		...
		lblCommandDelay = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblCommandDelay.text")); //$NON-NLS-1$
		...
		//
		lblBaudrate = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblBaudrate.text")); //$NON-NLS-1$
		...
		// reference value
		lblReference = new JLabel(VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblReference.text")); //$NON-NLS-1$
		...
		btOK = new JButton(VNADriverSerialVNArduinoMessages.getString("Button.OK"));
	...
	protected void doOK() {
		...
		int frq = IntegerValidator.parse(txtTicks.getText(), 999999, 999999999, VNADriverSerialVNArduinoMessages.getString("Dialog.lblDDSTicks.text"), results);
		int openTimeout = IntegerValidator.parse(txtOpenTimeout.getText(), 500, 99000, VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblOpenTimeout.text"), results);
		int readTimeout = IntegerValidator.parse(txtReadTimeout.getText(), 500, 99000, VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblReadTimeout.text"), results);
		int commandDelay = IntegerValidator.parse(txtCommandDelay.getText(), 50, 99000, VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblCommandDelay.text"), results);
		int baudrate = IntegerValidator.parse(txtBaudrate.getText(), 1200, 115200, VNADriverSerialVNArduinoMessages.getString("VNADriverSerialStdDialog.lblBaudrate.text"), results);
		int steps = IntegerValidator.parse(txtSteps.getText(), 2000, 25000, VNADriverSerialVNArduinoMessages.getString("Dialog.lblNoOfSteps.text"), results);
