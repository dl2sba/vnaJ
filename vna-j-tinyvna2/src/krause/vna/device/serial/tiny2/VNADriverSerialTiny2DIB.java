...
public class VNADriverSerialTiny2DIB extends VNASerialDeviceInfoBlock {
	...
	public static final int CAL_STEPS = 2000;
	...
	public VNADriverSerialTiny2DIB() {
		TraceHelper.entry(this, "VNADriverSerialTiny2DIB");
		//
		reset();
		//
		...
		//
		setShortName("miniVNA Tiny2");
		setLongName("mini radio solutions - miniVNA Tiny2");
		setType(VNADriverFactorySymbols.TYPE_TINYVNA2);

		TraceHelper.exit(this, "VNADriverSerialTiny2DIB");
	}
	...
	public void reset() {
		...
		setNumberOfOverscans4Calibration(2);

		// special settings for the tinyvna
		setPrescaler(PRESCALER_DEFAULT);

		if (hasReferenceChannel()) {
			setScanCommandTransmission("106");
			setScanCommandReflection("107");
		} else {
