...
public class VNADriverSerialStd extends VNADriverSerialBase {
	...
	public VNADriverSerialStd() {
		final String methodName = "VNADriverSerialStd";
		TraceHelper.entry(this, methodName);

		setMathHelper(new VNADriverSerialStdMathHelper(this));
		setDeviceInfoBlock(new VNADriverSerialStdDIB());
		//
	...
	public void init() throws InitializationException {
		...
		super.init();
		//
		VNADriverSerialStdDIB dib = (VNADriverSerialStdDIB) getDeviceInfoBlock();
