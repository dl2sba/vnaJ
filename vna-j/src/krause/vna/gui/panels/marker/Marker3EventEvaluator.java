 ...
 *
 *	This file: Marker3EventEvaluator.java
 *  Part of:   vna-j
 */
...
public class Marker3EventEvaluator implements IMarkerEventEvaluator {
	...
	public boolean isMyMouseEvent(MouseEvent e) {
		return ((e.getButton() == MouseEvent.BUTTON1) && ((e.getModifiersEx() & (InputEvent.SHIFT_DOWN_MASK + InputEvent.CTRL_DOWN_MASK + InputEvent.ALT_DOWN_MASK)) == (InputEvent.SHIFT_DOWN_MASK + MouseEvent.CTRL_DOWN_MASK)));
	}
	...
	public boolean isMyMouseWheelEvent(MouseWheelEvent e) {
		return ((e.getModifiersEx() & (InputEvent.SHIFT_DOWN_MASK + InputEvent.CTRL_DOWN_MASK + InputEvent.ALT_DOWN_MASK)) == (InputEvent.SHIFT_DOWN_MASK + InputEvent.CTRL_DOWN_MASK));
	}
}
