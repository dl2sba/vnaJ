...
public class VNAGeneratorPro2Dialog extends KrauseDialog implements ChangeListener, ActionListener, ClipboardOwner, AdjustmentListener, ILocationAwareDialog {
	...
	public static final int MAX_PHASE = 360 * 100;
	...
	public VNAGeneratorPro2Dialog(VNAMainFrame pMainFrame, IVNADriver pDriver) {
		...
		driver = pDriver;
		dib = (VNADriverSerialPro2DIB) driver.getDeviceInfoBlock();

		setTitle(VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.title"));
		...
		btOK = new JButton(VNADriverSerialPro2Messages.getString("Button.Close"));
	...
	private JPanel createNUMPanel() {
		...
		panelNUM.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.control"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblEndWithFor = new JLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblEndWithFor.text")); //$NON-NLS-1$
		...
		lblOnAir = new JLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblOnAir.text")); //$NON-NLS-1$
		panel2.add(lblOnAir);
	...
	private JPanel createHELPPanel() {
		...
		panelHLP.setBorder(new TitledBorder(null, VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.help"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtrFEnterI.setText(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.txtrFEnterI.text")); //$NON-NLS-1$
	...
	private JPanel createPHASEPanel() {
		...
		panelPhase.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.phaseDiff"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panelPhase.add(createNewLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.label_7.text")), "wrap");
	...
	private JPanel createFREQPanel() {
		...
		panelFRQ.setBorder(new TitledBorder(null, VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.Frequency"), TitledBorder.LEADING, TitledBorder.TOP, null, null));

		JPanel panelFRQI = new JPanel(new MigLayout("", "0", "0"));
		panelFRQ.add(panelFRQI, "");
		panelFRQI.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.frq.i"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btLinkFrq = new JToggleButton(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.toggleButton.text")); //$NON-NLS-1$
		...
		JButton btFrqLeft2Right = new JButton(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.button_1.text")); //$NON-NLS-1$
		...
		panelFRQQ.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.frq.q"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
	...
	private JPanel createATTPanel() {
		...
		panelATT.setBorder(new TitledBorder(null, VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.att"), TitledBorder.LEADING, TitledBorder.TOP, null, null));

		JPanel panelATTI = new JPanel(new MigLayout("", "", ""));
		panelATTI.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.att.i"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panelATTI.add(createNewLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblDb.text")), "");

		JPanel panelATTCenter = new JPanel(new MigLayout("", "", ""));
		panelATT.add(panelATTCenter, "");
		JButton btAttRight2Left = new JButton(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.button_2.text")); //$NON-NLS-1$
		...
		JButton btAttLeft2Right = new JButton(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.button_3.text")); //$NON-NLS-1$
		...
		panelATTQ.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), VNADriverSerialPro2Messages.getString("VNAGeneratorPro.Dialog.att.q"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panelATTQ.add(createNewLabel(VNADriverSerialPro2Messages.getString("VNAGeneratorDialog.lblDb.text")), "");
